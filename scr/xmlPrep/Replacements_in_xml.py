...
# ## Generating UUID to replace alphanumeric Geolcode (old TID)
# #############################################################
...
# print(df)
# df.to_excel(r'C:\Projects\Replacements\ReplaceList_UUID.xlsx')
...
#############################################################
data = et.parse('GeologyModelLookUp_V3.0_modified_b002.xml')
root = data.getroot()
